...
const Signup = () => {
    const submit = async ()=>{
        ...
        if (password.value.length < 6){
            ...
            error.innerHTML = `<p className=${styles.inputError}>Password must be atleast 6 characters long</p>`;
            errorFlag=true
        }else if (password.value != confPassword.value){
            confPassword.classList.add('incorrect-input');
            error.innerHTML = `<p className=${styles.inputError}>Password is not matching</p>`;
            errorFlag=true;
        }
        ...
        <div id="signup-container" className={styles.container}>
            ...
            <div id="identification-credentials" className={styles.identificationContainer}>
                <div id="input-fields" className={styles.inputFields}>
                    ...
                    <input type="text" class={styles.phoneNum} id="num" name='num' placeholder='Phone number' required maxLength="10" /><span class={styles.countryCode}>+91 </span>
