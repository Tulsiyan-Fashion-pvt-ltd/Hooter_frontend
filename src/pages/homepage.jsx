...
const Homepage = () => {
  ...
  const platforms = [
    "Lets Check All", "Lets Check Flipkart", "Lets Check Amazon",
    "Lets Check Shopify", "Lets Check Website", "Lets Check Meesho",
    "Lets Check Myntra", "Lets Check Ajio",
  ];
  ...
  const insightsTabs = [
    "All ( 26 )", "Top Rated", "Best Seller", "New Listings", "Out Of Stocks"
  ];
  ...
  const fetchDashboardData = useCallback(async () => {
    ...
    try {
      const mockDataByPlatform = {
        0: { orders: { value: 42,  change: 12,  percentage: 65 }, shipping: { value: 36,  change: -8,  percentage: 45 }, activeUsers: { value: 108, change: 18,  percentage: 72 }, returns: { value: 16, change: -15, percentage: 30 } },
        1: { orders: { value: 89,  change: 25,  percentage: 85 }, shipping: { value: 72,  change: 15,  percentage: 68 }, activeUsers: { value: 287, change: 20,  percentage: 78 }, returns: { value: 31, change: -5,  percentage: 42 } },
        2: { orders: { value: 112, change: -10, percentage: 38 }, shipping: { value: 95,  change: 8,   percentage: 62 }, activeUsers: { value: 354, change: -12, percentage: 35 }, returns: { value: 38, change: 22,  percentage: 88 } },
        3: { orders: { value: 45,  change: -18, percentage: 28 }, shipping: { value: 38,  change: -22, percentage: 25 }, activeUsers: { value: 156, change: -8,  percentage: 45 }, returns: { value: 18, change: 15,  percentage: 70 } },
        4: { orders: { value: 34,  change: 32,  percentage: 90 }, shipping: { value: 29,  change: 28,  percentage: 85 }, activeUsers: { value: 98,  change: 35,  percentage: 92 }, returns: { value: 12, change: -20, percentage: 22 } },
        5: { orders: { value: 28,  change: 5,   percentage: 55 }, shipping: { value: 24,  change: -3,  percentage: 48 }, activeUsers: { value: 87,  change: 8,   percentage: 60 }, returns: { value: 9,  change: -2,  percentage: 38 } },
        6: { orders: { value: 21,  change: -5,  percentage: 42 }, shipping: { value: 17,  change: 12,  percentage: 68 }, activeUsers: { value: 65,  change: -15, percentage: 32 }, returns: { value: 8,  change: 18,  percentage: 75 } },
        7: { orders: { value: 13,  change: -25, percentage: 20 }, shipping: { value: 11,  change: -18, percentage: 28 }, activeUsers: { value: 42,  change: -22, percentage: 25 }, returns: { value: 8,  change: 30,  percentage: 95 } },
      };

      const p = mockDataByPlatform[activePlatform];
      setMetricsData({
        orders:      { value: p.orders.value,      change: p.orders.change,      percentage: p.orders.percentage },
        shipping:    { value: p.shipping.value,    change: p.shipping.change,    percentage: p.shipping.percentage },
        activeUsers: { value: p.activeUsers.value, change: p.activeUsers.change, percentage: p.activeUsers.percentage },
        returns:     { value: p.returns.value,     change: p.returns.change,     percentage: p.returns.percentage },
      });
      setChartData({
        ordersBarData:  Array.from({ length: 7 }, (_, i) => ({ day: i + 1, value: Math.floor(Math.random() * 30) + 10 })),
        shippingTrend:  [
          { day: 1, value: 20 }, { day: 2, value: 32 }, { day: 3, value: 28 },
          { day: 4, value: 35 }, { day: 5, value: 25 }, { day: 6, value: 30 }, { day: 7, value: 38 },
        ],
        returnsBarData: Array.from({ length: 7 }, (_, i) => ({ day: i + 1, value: Math.floor(Math.random() * 30) + 10 })),
      });
    } catch (error) {
  ...
  const fetchBusinessInsightsData = useCallback(async () => {
    try {
      ...
      setStatisticsData({
        ...
        barData: [
          { value: 25 + activePlatform * 3 }, { value: 60 + activePlatform * 5 },
          { value: 35 + activePlatform * 2 }, { value: 100 - activePlatform * 4 },
          { value: 45 + activePlatform * 3 }, { value: 30 + activePlatform * 2 },
        ],
  ...
  const getPercentageBgColor = (change) => change >= 0 ? '#00AF551A' : '#E513001A';
  const getChartColor        = (change) => change >= 0 ? '#0040D6' : '#E51300';

  const getTrendArrow = (change) => change >= 0 ? (
  ...
  const getPieChartArrow = (change) => change >= 0 ? (
            ...
            <div className={clsx(styles.card, styles.platforms)}>
              <div className={styles.platformsRow}>
                {platforms.map((platform, index) => (
                  <button
                    key={index}
                    className={clsx(styles.platformBtn, activePlatform === index && styles.active)}
                ...
                <div className={styles.metricBody}>
                  <div className={styles.metricLeft}>
                    ...
                    <div className={styles.metricChange}>
                      <div className={styles.percentageContainer} style={{ backgroundColor: getPercentageBgColor(metricsData.orders.change) }}>
                  ...
                  <div className={styles.metricChart}>
                    <ResponsiveContainer width="100%" height={60}>
                      <BarChart data={chartData.ordersBarData}>
                        <Bar dataKey="value" fill={getChartColor(metricsData.orders.change)} radius={[4, 4, 0, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </div>
              ...
              <div className={clsx(styles.card, styles.metricCard, styles.shippingCard)}>
                ...
                <div className={styles.metricBody}>
                  <div className={styles.metricLeft}>
                    ...
                    <div className={styles.metricChange}>
                      <div className={styles.percentageContainer} style={{ backgroundColor: getPercentageBgColor(metricsData.shipping.change) }}>
                  ...
                  <div className={styles.metricChart}>
                    <ResponsiveContainer width="100%" height={60}>
                      <LineChart data={chartData.shippingTrend}>
                        <Line type="monotone" dataKey="value" stroke={getChartColor(metricsData.shipping.change)} strokeWidth={2} dot={false} />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </div>
              ...
              <div className={clsx(styles.card, styles.metricCard, styles.usersCard)}>
                ...
                <div className={styles.metricBody}>
                  <div className={styles.metricLeft}>
                    ...
                    <div className={styles.metricChange}>
                      <div className={styles.percentageContainer} style={{ backgroundColor: getPercentageBgColor(metricsData.activeUsers.change) }}>
                  ...
                  <div className={styles.metricChart}>
                    <div className={styles.pieChartContainer}>
                      <PieChart width={100} height={100}>
                        <Pie
                          data={[{ value: metricsData.activeUsers.percentage }, { value: 100 - metricsData.activeUsers.percentage }]}
                          cx={50} cy={50} innerRadius={32} outerRadius={45}
              ...
              <div className={clsx(styles.card, styles.metricCard, styles.returnsCard)}>
                ...
                <div className={styles.metricBody}>
                  <div className={styles.metricLeft}>
                    ...
                    <div className={styles.metricChange}>
                      <div className={styles.percentageContainer} style={{ backgroundColor: getPercentageBgColor(metricsData.returns.change) }}>
                  ...
                  <div className={styles.metricChart}>
                    <ResponsiveContainer width="100%" height={60}>
                      <BarChart data={chartData.returnsBarData}>
                        <Bar dataKey="value" fill={getChartColor(metricsData.returns.change)} radius={[4, 4, 0, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </div>
              ...
              <div className={styles.insightsTabsWrapper}>
                <div className={styles.insightsTabs}>
                  {insightsTabs.map((tab, index) => (
                    <button
                      key={index}
                      className={clsx(styles.insightsTab, activeTab === index && styles.activeInsightsTab)}
                      ...
                      <div className={styles.productDetailsSection}>
                        ...
                        <div className={styles.productBarChart}>
                          <ResponsiveContainer width="100%" height={180}>
                            <BarChart data={bestSellerData.chartData} barCategoryGap="5%" barGap={1} margin={{ top: 10, right: 10, bottom: 10, left: 10 }}>
                      ...
                      <div className={styles.statsChartArea}>
                        <ResponsiveContainer width="100%" height={350}>
                          <LineChart data={statisticsData.weeklyData} margin={{ top: 5, right: 5, bottom: 20, left: 10 }}>
                            ...
                            <XAxis dataKey="day" stroke="#999" style={{ fontSize: '11px', fontFamily: 'Inter', fontWeight: 400 }} axisLine={false} tickLine={false} dy={10} />
                            <YAxis stroke="#999" style={{ fontSize: '11px', fontFamily: 'Inter', fontWeight: 400 }} axisLine={false} tickLine={false} tickFormatter={(value) => `${value / 1000}k`} dx={-5} />
                            <Tooltip />
                            <Line type="monotone" dataKey="value1" stroke={statisticsData.performanceChange >= 0 ? '#0040D6' : '#E51300'} strokeWidth={2} dot={{ fill: statisticsData.performanceChange >= 0 ? '#0040D6' : '#E51300', r: 5, strokeWidth: 2, stroke: '#fff' }} />
                            <Line type="monotone" dataKey="value2" stroke={statisticsData.performanceChange >= 0 ? '#0040D6' : '#E51300'} strokeWidth={2} dot={false} />
                          </LineChart>
                        </ResponsiveContainer>
                            ...
                            <div className={styles.returnsBarChart}>
                              <ResponsiveContainer width="100%" height={100}>
                                <BarChart data={statisticsData.barData}>
                                  <Bar dataKey="value" fill={statisticsData.returnsChange < 0 ? '#0040D6' : '#E51300'} radius={[4, 4, 0, 0]} />
                                </BarChart>
                              </ResponsiveContainer>
                            </div>
